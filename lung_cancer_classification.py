...
Original file is located at
    https://colab.research.google.com/drive/1o6vKfqcAnGd4YpASRrLxl7PHojRvbKhg
"""

# Colab install command: !pip install -q timm
...
# Colab install command: !pip install -q timm opencv-python
